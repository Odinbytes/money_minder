...
This is a RESTful API that allows users to track their income and expenses over time(daily,. The App provides CRUD operations for managing income and expenses, as well as features for generating monthly and yearly spending reports and setting budget limits. This project is extended into a full-stack application with data visualization.
